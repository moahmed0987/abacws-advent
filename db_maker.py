...
puzzles = []
puzzles.append(Puzzle(puzzle="""You have been given a grid, using the numbers to find the encrypted word. You need to go along the y-axis and down the x-axis e.g 2.1 is going along number 2 and down by 1, giving the letter b.
Find the encrypted word for this code 3.4 5.3 4.5 2.5 1.1 2.4 5.1  """, date=date.today(), answer=""))
