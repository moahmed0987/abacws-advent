...
class RegistrationForm(FlaskForm):
    ...
    password_new = PasswordField("Password", validators=[DataRequired(), Length(5, 20, message="Password must be between 5 and 20 characters long. Try again."), EqualTo("password_confirm", message="Passwords do not match. Try again.")])
